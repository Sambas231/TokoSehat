...
public class DrugDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String SQL_CREATE_TABLE = "CREATE TABLE " + DrugEntry.TABLE_NAME + "("
                ...
                + DrugEntry.COLUMN_DRUG_PRICE_ITEM + " INTEGER NOT NULL DEFAULT 0, "
                + DrugEntry.COLUMN_DRUG_PRICE_DOZEN + " INTEGER DEFAULT 0, "
                + DrugEntry.COLUMN_DRUG_PRICE_BOX + " INTEGER DEFAULT 0, "
